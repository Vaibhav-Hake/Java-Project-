        ...
        meterText.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                try{
                    ...
                    ResultSet resultSet = c.statement.executeQuery("select * from name  where meter_no = '"+meterText.getText()+"'");
                    if (resultSet.next()){
        ...
        if (e.getSource()== create){
            ...
            try{
                ...
                if (loginASCho.equals("Admin")) {
                    query = "insert into name values('"+smeter+"', '"+susername+"', '"+sname+"','"+spassword+"','"+sloginAs+"')";
               }else {
                    query = "update name set username = '"+susername+"', password = '"+spassword+"', sertype ='"+sloginAs+"' where meter_no = '"+smeter+"'";
                }
